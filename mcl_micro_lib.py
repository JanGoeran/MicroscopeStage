...
class MadMicroDrive:
    ...
    def __init__(self):
        ...
        #pointers
        self.encoderRes = c_double()
        self.encoderRes_pointer = pointer(self.encoderRes)
        self.stepSize = c_double()
        self.stepSize_pointer = pointer(self.stepSize)
        self.maxVelocity = c_double()
        self.maxVelocity_pointer = pointer(self.maxVelocity)
        self.maxVelocityTwoAxis = c_double()
        self.maxVelocityTwoAxis_pointer = pointer(self.maxVelocityTwoAxis)
        self.maxVelocityThreeAxis = c_double()
        self.maxVelocityThreeAxis_pointer = pointer(self.maxVelocityThreeAxis)
        self.minVelocity = c_double()
        self.minVelocity_pointer = pointer(self.minVelocity)

        self.firmwareVersion = c_short()
        self.firmwareVersion_pointer = pointer(self.firmwareVersion)
        self.firmwareProfile = c_short()
        self.firmwareProfile_pointer = pointer(self.firmwareProfile)

        self.encoderBM = c_ubyte()
        self.encoderBM_pointer = pointer(self.encoderBM)

        self.axisBM = c_ubyte()
        self.axisBM_pointer = pointer(self.axisBM)
        ...
        #for encoder
        self.e1 = c_double()
        self.e1_pointer = pointer(self.e1)
        self.e2 = c_double()
        self.e2_pointer = pointer(self.e2)
        self.e3 = c_double()
        self.e3_pointer = pointer(self.e3)
        self.e4 = c_double()
        self.e4_pointer = pointer(self.e4)
    ...
    def get_information(self):
        ...
        mcl_get_info(self.encoderRes_pointer, self.stepSize_pointer, self.maxVelocity_pointer,
                     ...
                     self.minVelocity_pointer, c_int(self.handler))
    ...
    def encoder_present(self):
        ...
        mcl_encoder_present.restype = c_int
        mcl_encoder_present(self.encoderBM_pointer, c_int(self.handler))
    ...
    def set_origin(self):
        ...
        mcl_reset_encoders.restype = c_int
        mcl_reset_encoders(self.status_pointer, c_int(self.handler))
    ...
    def read_encoders(self):
        ...
        mcl_read_encoders.restype = c_int
        mcl_read_encoders(self.e1_pointer, self.e2_pointer, self.e3_pointer, self.e4_pointer, c_int(self.handler))
    ...
    def get_serial(self):
        ...
        mcl_get_serial.restype = c_int
        serial = mcl_get_serial(c_int(self.handler))
    ...
    def get_axis_info(self):
        ...
        mcl_get_axis_info.restype = c_int
        mcl_get_axis_info(self.axisBM_pointer, c_int(self.handler))
